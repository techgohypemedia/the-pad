...
const OurStory = () => {
  ...
  return (
    <div className="bg-black text-white min-h-screen flex flex-col">
      {/* Hero Section */}
      <section className="px-6 pt-40 md:pt-48 pb-12 text-center max-w-[1400px] mx-auto transition-all">
        <motion.div
          ...
          className="w-full"
        >
          <h1 className="text-4xl md:text-7xl lg:text-[5.5rem] font-bold uppercase tracking-[-0.04em] leading-[0.9] mb-6 flex flex-col items-center">
...
const ScrollStatementSection = () => {
  ...
  const y1 = useTransform(scrollYProgress, [0.05, 0.25], [20, 0]);
  ...
  const y3 = useTransform(scrollYProgress, [0.35, 0.55], [20, 0]);
  ...
  return (
    <section ref={containerRef} className="relative h-[110vh] bg-black">
      <div className="sticky top-0 h-screen w-full flex flex-col justify-center px-6 md:px-12 overflow-hidden">
        <div className="max-w-[1400px] mx-auto w-full relative pt-6 md:pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-8 pt-8 md:pt-12">
            <motion.div style={{ opacity: opacity1, y: y1 }} className="flex flex-col">
              <h3 className="text-2xl md:text-2xl lg:text-3xl font-bold uppercase tracking-[-0.04em] leading-[0.9] text-white">
            ...
            <motion.div style={{ opacity: opacity3, y: y3 }} className="flex flex-col">
              <Link to="/services" className="group cursor-pointer block">
                <h3 className="text-2xl md:text-2xl lg:text-3xl font-bold uppercase tracking-[-0.04em] leading-[0.9] text-reserve-accent">
                  THE PAD IS <br />
